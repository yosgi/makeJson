...
sdays = 1 # 允许抓取天数
baseurl = "https://www.zgznh.com/"

urls = ["https://www.zgznh.com/news/list-437-0++0.html","https://www.zgznh.com/news/list-437-0++0.html","https://www.zgznh.com/news/list-511-0++0.html","https://www.zgznh.com/news/list-1239-0++0.html","https://www.zgznh.com/news/list-1245-0++0.html"]
...
def level1(ourl=None):
    ...
    try:
         ...
         ret = requests.get(lurl,verify=False,headers=getheader(),timeout=20)
         rdata = ret.content
         ...
         print( "中国智能化网")
         text = soup.find(name='div', attrs={"class":"catlist"})
         if text:
             ...
             for item in allmes:
                 ...
                 if turl:
                     ...
                     tdate = item.find(name='i').text.split()[0]
                     print(turl)
                     print(tdate)
                     if tdate in days:
             ...
             eday = allmes[-2].find(name='i').text.split()[0]
             print(eday)
             if eday in days:
                 print(days)
                 print("末尾日期为",eday)
...
def target(arg,count=1):
    ...
    try:
        ...
        articles = ""
        soup = BeautifulSoup(rdata,"html.parser")
        text = soup.find(name="div",attrs={"class":"m3l"})
        title = text.find(name='h1',attrs={"id":"title"})
        print(title)
        introduce = soup.find(name='div',attrs={"class":"introduce"})
        article = soup.find(name='div', attrs={"id":"article"})
...
if __name__ == "__main__":
    ...
    for url in urls:
        ...
        print("新频道")
        print("")
    #target(('https://www.zgznh.com/news/show-869510.html',))
    print("--  end  --")
    #inmysql('1','1','1','1')
